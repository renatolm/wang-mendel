...
%figura do caminhão quase certo
%figura do caminhão certo
\begin{figure}
\hfill
\subfigure[Normal]{\includegraphics[scale=0.25]{quase.png}}
\hfill
\subfigure[Modificado]{\includegraphics[scale=0.25]{bom.png}}
\hfill
...
%figura da série de Mackey-Glass
\begin{figure}[H]
    %\centering
